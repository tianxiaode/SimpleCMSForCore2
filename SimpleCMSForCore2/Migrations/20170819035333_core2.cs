        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullPath = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    UserProfileType = table.Column<byte>(type: "tinyint", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_UserProfile", x => x.UserProfileId);
                    table.ForeignKey(
                        name: "FK_T_UserProfile_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_Content", x => x.Id);
                    table.ForeignKey(
                        name: "FK_T_Content_T_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_ContentTag", x => new { x.ContentId, x.TagId });
                    table.ForeignKey(
                        name: "FK_T_ContentTag_T_Content_ContentId",
                        column: x => x.ContentId,
                        principalTable: "T_Content",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_T_ContentTag_T_Tag_TagId",
                        column: x => x.TagId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_Content_CategoryId",
                table: "T_Content",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_T_ContentTag_TagId",
                table: "T_ContentTag",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_T_UserProfile_UserId",
                table: "T_UserProfile",
                column: "UserId");
